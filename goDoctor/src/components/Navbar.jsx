...
const Navbar = () => {
  ...
  const { token, setToken, userData, setUserData, initializing } =
    ...
    <div className="flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-500">
      ...
      <div className="flex items-center gap-4">
        {initializing ? (
          ...
          <div
            className="flex items-center group relative gap-2 cursor-pointer"
          ...
          <button
            ...
            className="px-6 py-3 text-white bg-primary rounded-full font-light hidden md:block hover:underline"
          >
            Create Account
          </button>
        )}
