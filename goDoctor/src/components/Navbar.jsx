...
//                   <p onClick={()=>{navigate('/myappointments')}} className='hover:text-primary cursor-pointer'>My appointments</p>
//                   <Link to={'/'}>
...
//             <NavLink to='/doctors'> All </NavLink>
...
//hover functionality  on small screens::::::
