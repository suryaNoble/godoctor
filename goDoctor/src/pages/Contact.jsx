...
const Contact = () => {
  return (
    <section className="body-font relative bg-gray-900 text-gray-400 rounded-lg">
    ...
    <div className="mx-auto md:w-2/3 lg:w-1/2">
      ...
      <form action="/" method="post">
        ...
        <div className="mt-8 w-full border-t border-gray-800 p-2 pt-8 text-center">
            {/* <a href="/" className="font-medium text-blue-600 hover:underline">Or click here to reveal our protected email address</a> */}
    
          <p className="my-5 leading-normal">pedda chepala Road. <br />Maredumalli, 533449</p>
